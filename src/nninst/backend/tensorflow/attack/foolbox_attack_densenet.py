...
from nninst.backend.tensorflow.attack.common import (
    densenet_cifar10_real_metrics_per_layer,
)
...
from nninst.backend.tensorflow.trace.densenet_cifar10_class_trace import (
...
if __name__ == "__main__":
    ...
    for threshold, absolute_threshold in itertools.product(
        ...
        #     DENSENET_CIFAR10, threshold=threshold, absolute_threshold=absolute_threshold
        # )
            ...
            * compare_with_full
            ...
            with config:
                ...
                entry_points = get_entry_points(
                    DenseNet.graph().load(), layer_num.value
                )
                ...
                path_template = (
                    "densenet_cifar10_real_metrics_per_layer_{0:.1f}_{1}_{2}.csv"
                )
                per_node = False
                # per_node = True
                # per_channel = True
                # per_channel = False
                densenet_overlap_ratio = densenet_cifar10_real_metrics_per_layer(
                    ...
                    class_trace_fn=lambda class_id: densenet_cifar10_class_trace_compact(
                        class_id,
                        threshold,
                        label=label,
                        variant=variant,
