...
from nninst.backend.tensorflow.dataset.cifar10_main import input_fn
...
def train(
    ...
    if label is None:
        model_dir = abspath("tf/resnet-18-cifar10/model_train/")
    else:
        model_dir = abspath(f"tf/resnet-18-cifar10/model_{label}/")
    # data_dir = abspath("/home/yxqiu/data/cifar10-raw")
    data_dir = abspath("/state/ssd0/yxqiu/data/cifar10-raw")
